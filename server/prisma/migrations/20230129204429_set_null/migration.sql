...
-- AddForeignKey
ALTER TABLE "stocks" ADD CONSTRAINT "stocks_productVariantOptionId2_fkey" FOREIGN KEY ("productVariantOptionId2") REFERENCES "product_variant_options"("id") ON DELETE SET NULL ON UPDATE CASCADE;
