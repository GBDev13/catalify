    ...
    <section className="overflow-x-hidden">
      ...
      <div className="home-container flex items-center mt-[90px] gap-2 flex-col-reverse sm:flex-row">
        <div className="sm:mt-8">
          <h1 className="text-4xl sm:text-[40px] sm:leading-[50px] md:text-[50px] md:leading-[60px] lg:text-[70px] lg:leading-[80px] font-semibold text-slate-800">
            Catálogo digital que simplifica suas vendas!
          </h1>
          <p className="text-base md:text-lg mt-6 text-slate-500 font-light">
          ...
          <button onClick={handleStart} className="bg-indigo-500 hover:bg-indigo-400 transition-colors text-white px-4 py-2 rounded-md mt-2">
            Começar agora
          </button>
        </div>

        <img src="/images/landing.png" className="relative sm:-mr-[400px] md:-mr-[480px] lg:-mr-[550px] w-[950px]" />
      </div>
    </section>
  )
}