    ...
    <>
      ...
      {catalogInfoIsLoading ? (
        ...
        <form className="w-full grid grid-cols-2 gap-4 mt-10" onSubmit={handleSubmit(onSubmit)}>
          ...
          <ControlledInput disabled={!isEditing} tip="Texto que será usado para acessar sua loja através do link do navegador (ex: sualoja.catalify.com.br)" label="Slug da loja" placeholder="sualoja" fieldName="slug" control={control} />
