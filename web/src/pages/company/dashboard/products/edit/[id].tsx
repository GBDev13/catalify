...
import { createProduct, CreateProductDto, editProduct, EditProductDto, getCategories, getProductById } from "src/services/products";
...
export default function EditProduct() {
  ...
  const onSubmit = async (data: EditProductFormData) => {
    ...
    await handleEditProduct({
      ...
      variations: removedAllVariations ? { added: [], edited: [], removed: product.variants.map(x => ({
        id: x.id,
        actionType: 'remove',
        type: 'variation'
